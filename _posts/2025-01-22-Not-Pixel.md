...
title: "Not Pixel"
date: 2025-01-22
categories: ["gaming", "meme", "ton-ecosystem"]
...
| Information         | Details                                                                                                        |
| ------------------- | -------------------------------------------------------------------------------------------------------------- |
| Project Name        | Not Pixel                                                                                                      |
| Project Website     | Not Known                                                                                                      |
| Project Description | A pixel-based gaming ecosystem that integrates cryptocurrency rewards, player achievements, and NFT utilities. |
| Project Ticker      | PX                                                                                                             |
...
- **Bot Token Redistribution:** Tokens identified as bot-farmed are redistributed among **real users** to ensure fairness.
...
- **Bot Tokens Redistribution:** **78% of bot tokens** are given to active players based on achievements, and **22% of bot tokens are burned**.
