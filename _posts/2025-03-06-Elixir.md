...
title: "Elixir"
date: 2025-03-06
categories: ["infrastructure", "tokenization", "real-assets", "rwa","ethereum-ecosystem"]
tags: [all, retroactive,2k25]
---
...
| Information         | Details                                                                                  |
| ------------------- | ---------------------------------------------------------------------------------------- |
| Project Name        | Elixir Network                                                                           |
| Project Website     | [https://elixir.finance](https://elixir.finance)                                         |
| Project Description | Elixir is the most widely adopted network by RWAs, bringing funds from institutions like |
|                     | BlackRock, Hamilton Lane, and Apollo into DeFi through deUSD.                            |
| Project Ticker      | ELX                                                                                      |
