...
title: "Raft"
date: 2023-10-11
categories: ["defi", "lending", "staking", "ethereum-ecosystem"]
...
| ------------------- | --------------------------------------------------------------------------------------------------------- |
| Project Name        | Raft                                                                                                      |
| Project Website     | [Raft Website](https://www.raft.fi/)                                                                      |
| Project Description | Raft is a decentralized finance (DeFi) platform focused on stablecoin lending and liquidity provisioning. |
| Project Ticker      | RAFT                                                                                                      |
