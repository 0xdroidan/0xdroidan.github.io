...
Guru Network does not conduct traditional airdrops. Instead, it offers initial sign-up rewards to users upon joining the mainnet, designed to kickstart participation and recognize contributions made during the testnet phase. Early adopters and NFT holders receive significantly higher rewards due to multipliers from their holdings.

## Basic Information

| Information         | Details                                                                                                                                                                                                             |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Project Name        | Guru Network                                                                                                                                                                                                        |
| Project Website     | [https://gurunetwork.ai](https://gurunetwork.ai)                                                                                                                                                                    |
| Project Description | Guru Network is a decentralized platform focused on creating a fair and transparent ecosystem for users, offering various applications and AI-powered tools to enhance user experience within the blockchain space. |
| Project Ticker      | GURU                                                                                                                                                                                                                |
