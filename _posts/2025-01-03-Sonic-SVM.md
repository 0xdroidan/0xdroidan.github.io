...
| Project Website     | [Sonic SVM](https://sonic.feather.blog)                                                                                                                |
| Project Description | The first SVM network extension on Solana, designed for games and applications. It powers the Web3 TikTok App Layer to onboard the next billion users. |
| Project Ticker      | SONIC                                                                                                                                                  |
